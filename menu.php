...
<html lang="en">
<head>
	<title>Ultimate Foods | Menu</title>
	<meta charset="UTF-8">
...
<body>
    ...
    <div id="page">
        ...
        <div class="row" id="banner">
            <div class="col-lg-12">
            P I Z Z A
            <img src="line.png" class="img-fluid" id="underline" alt="Pizza" ></img>
            </div>
        </div>
        ...
        <?php
            ...
            $search="SELECT type, name, price, description, url FROM menuItems";
            ...
            if ($result) {
                while($row = $result->fetch_assoc()) {
                    if ($row['type'] == "pizza"){
                        ...
                        printf("<button type=\"button\" class=\"btn btn-danger\">Add To Cart</button>");
                        printf("</div>");
                        printf("</div>");
                        printf("</div>");
                        printf("<br>");
    ...
    <footer id="footer">
        <div class="container">
            <div class="hidden-sm" style="clear:both;" >
                <footer><em>@Copyright 2020-2021<strong> Ultimate Foods.</strong> All rights reserved.</em> </footer>
            </div>
        </div>
    </footer>
</body>
